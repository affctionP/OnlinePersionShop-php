    ...
    if(!isset($_GET['brand_id'])&&!isset($_GET['cat_id'])){
        ...
        $row_products=mysqli_fetch_array($run_products);
            ...
            <div class='product-box'>
                ...
                <p><a href='product_detail.php?product_id=$product_id'><img src='themes/images/ladies/1.jpg'/></a></p>
                <a href='#' class='title'>$product_title</a><br/>
                <a href='products.html' class='category'>$product_cat</a>
...
function get_all_product(){
    ...
    echo "<h4 style='text-align:center;'> <span>New products</span></h4>";
...
function cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        if(mysqli_num_rows($run)>0){
            ...
            $insert_p="insert into cart (p_id,ip_add,quantity)values ('$product_id','$ip',1)";
				...
				
	{
	    ...
	    while($pp_price=@mysqli_fetch_array($run_pro_price))
					
			{
                ...
                echo "<tr>
                <td><a href='product_detail.html'><img src='admin_area/$product_image'></a></td>
                   <td>$product_title</td>
                   <td>$single_price</td>
		...
		}else
		{
			...
			echo "<td><input type='text' size='4' name='$str_ip$product_id' value='$quantity'></td>";
			$total=($single_price*(int)$quantity);
            $sum+=($single_price*(int)$quantity);
